...
|       |     |<a name="metadata_admin">Metadata Admin</>| A person responsible for assisting the Metadata Editor in their duties.  This includes Publishing and Archiving on request.|
|       |     |<a name="metadata_editor">Metadata Editor</>| A person responsible for creating or maintaining metadata in the BC Data Catalogue.|
