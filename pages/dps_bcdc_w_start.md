...
+ For datasets licensed under Open Data, these organizations will require their own Open Government Licence. See [Licences](./dps_licences.html) section below for more information on this.  
...
See the BC Data Catalogue [Publication Workflow](./dps_bcdc_w.html)
