...
+ There are two ways:
   ...
   1. You may also upload datasets yourself to ArcGIS Online.  
      1. This consumes ArcGIS Online credits, so there may be a charge for doing this. 
	  1. Data can be published to ArcGIS Online in a variety of ways including, but not limited to, ArcMap, ArcGIS Pro, as well as uploading zipped shapefiles or geodatabases directly to your account.  For more information see:  https://doc.arcgis.com/en/arcgis-online/manage-data/publish-features.htm
